        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="p-4 lg:p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('categories.index') }}" class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-gray-900 bg-gray-100 rounded-lg font-medium text-sm sm:text-base">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 lg:ml-64 w-full">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="mb-6 lg:mb-8">
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Video Categories</h1>
                    <p class="text-sm sm:text-base text-gray-600">Browse videos by category</p>
                </div>
                ...
                @else
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
                        ...
                        <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">No categories available</h3>
                        <p class="text-sm sm:text-base text-gray-600">Check back soon for new categories.</p>
                    </div>
                @endif
            </div>
        </main>

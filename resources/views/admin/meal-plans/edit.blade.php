...
<head>
    ...
    <title>Edit Meal Plan - Admin</title>
        ...
        <main class="flex-1 lg:ml-64 w-full">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="mb-6 lg:mb-8">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Edit Meal Plan</h1>
                    <p class="text-sm sm:text-base text-gray-600">Update meal plan information</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8">
                    <form action="{{ route('admin.meal-plans.update', $mealPlan) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $mealPlan->title) }}" required
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">{{ old('description', $mealPlan->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="image" id="image" value="{{ old('image', $mealPlan->image) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="calories" id="calories" value="{{ old('calories', $mealPlan->calories) }}" min="0"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">
                            @error('calories')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="breakfast" id="breakfast" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">{{ old('breakfast', $mealPlan->breakfast) }}</textarea>
                            @error('breakfast')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="lunch" id="lunch" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">{{ old('lunch', $mealPlan->lunch) }}</textarea>
                            @error('lunch')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="dinner" id="dinner" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">{{ old('dinner', $mealPlan->dinner) }}</textarea>
                            @error('dinner')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="snacks" id="snacks" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">{{ old('snacks', $mealPlan->snacks) }}</textarea>
                            @error('snacks')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $mealPlan->is_active) ? 'checked' : '' }}

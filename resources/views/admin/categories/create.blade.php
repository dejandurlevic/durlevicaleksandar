        ...
        <main class="flex-1 lg:ml-64 w-full">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="mb-6 lg:mb-8">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Create New Category</h1>
                    <p class="text-sm sm:text-base text-gray-600">Add a new category for organizing videos</p>
                </div>

                <!-- Form -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8 max-w-2xl">
                    <form action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:space-x-4">
                            <a href="{{ route('admin.categories.index') }}" class="px-4 sm:px-6 py-2 sm:py-3 border border-gray-300 text-gray-700 rounded-lg font-semibold text-sm sm:text-base hover:bg-gray-50 transition-colors text-center">
                                Cancel
                            </a>

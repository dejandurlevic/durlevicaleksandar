        ...
        <main class="flex-1 lg:ml-64 w-full">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="mb-6 lg:mb-8">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Edit Video</h1>
                    <p class="text-sm sm:text-base text-gray-600">Update video information</p>
                </div>
                    ...
                    <form action="{{ route('admin.videos.update', $video) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">{{ old('description', $video->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="video_path" id="video_path" value="{{ old('video_path', $video->video_path) }}" required
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="thumbnail" id="thumbnail" value="{{ old('thumbnail', $video->thumbnail) }}"
